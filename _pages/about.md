...
title: about
permalink: /
subtitle: Ph.D. Candidate in Computer Engineering, UC San Diego
...
profile: 
    ...
    more_info: >
        <div>
        <p>
        <a href="https://scholar.google.com/citations?user=i7vjNG4AAAAJ&hl=en">
            <i class="ai ai-google-scholar profile-scholar-icon"></i>
        </a>
        </p>
        <p>
        <a href="https://www.linkedin.com/in/ashkan-moradi-fir98/">
            <i class="fa-brands fa-linkedin profile-linkedin-icon"></i>
        </a>
        </p>
        <p class="profile-email"><br>ashkan [at] ucsd [dot] edu</p>
        </div>
...
I am a Ph.D. candidate in Computer Engineering at the University of California, San Diego, advised by [Prof. Mingu Kang](https://www.ucsdvvip.com/446873524/445916777). My research focuses on hardware-algorithm co-design for efficient AI systems, with an emphasis on LLM optimization, in-memory computing, VLSI, and computer architecture.
